                ...
                <div className="flex flex-col md:grid md:grid-cols-2 gap-6">
                    <Card className="p-6 md:p-10 flex flex-col justify-between">
                        ...
                        <div className="pt-6">
                            ...
                            <CardSubtitle>Access quarterly reports with deep dives into blockchain ecosystems, tokenomics, and key market shifts</CardSubtitle>
                        </div>
                    </Card>
                    <Card className="p-6 md:p-10 flex flex-col justify-between">
                        ...
                        <div className="pt-6">
                            ...
                            <CardSubtitle className="">Get premium research and data-driven investment insights, tailored for traders, investors, and analysts</CardSubtitle>
                        </div>
                    </Card>
                </div>
            </CustomSection>
