        ...
        <CustomSection className="relative">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <Card className="p-6 md:p-10 flex flex-col justify-between">
                    <div className="flex justify-center -mr-6 md:-mr-10"><img loading="lazy" src={fees} alt="" /></div>
                    <div className="pt-6">
                ...
                <Card className="p-6 md:p-10 flex flex-col justify-between">
                    <div className="flex justify-center  -mr-6 md:-mr-10"><img loading="lazy" src={token} alt="" /></div>
                    <div className="pt-6">
