            ...
            <div className="grid md:grid-cols-2 gap-6">
                <Card className="p-6 md:p-10 flex flex-col justify-between">
                    ...
                    <div className="pt-6">
                        ...
                        <CardSubtitle>Track Total Value Locked (TVL), protocol revenues, and asset prices in real time to spot early trends and high-growth projects</CardSubtitle>
                    </div>
                </Card>
                <Card className="p-6 md:p-10 flex flex-col justify-between">
                    ...
                    <div className="pt-6">
                        ...
                        <CardSubtitle>Stay ahead with insights on token unlock schedules, user activity, and liquidity metrics, helping you identify momentum shifts before the market reacts</CardSubtitle>
                    </div>
                </Card>
            </div>
        </CustomSection>
