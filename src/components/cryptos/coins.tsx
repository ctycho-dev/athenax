            ...
            <main className="bg-white py-6 px-2">
                ...
                <div className="max-w-7xl m-auto lg:shadow-default p-4 rounded-lg">
                    ...
                    <div className="flex justify-center items-center mt-4">
                        ...
                        >
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 md:w-6 md:h-6 rtl:rotate-180"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.3723 4.64576C14.5671 4.45141 14.883 4.45141 15.0778 4.64576L15.8539 5.41993C16.0487 5.61427 16.0487 5.92937 15.8539 6.12372L9.96317 12L15.8539 17.8763C16.0487 18.0706 16.0487 18.3857 15.8539 18.5801L15.0778 19.3542C14.883 19.5486 14.5671 19.5486 14.3723 19.3542L7 12L14.3723 4.64576Z" fill="currentColor"></path></svg>
                        </button>
                        {renderPageNumbers()}
                        <button
                            onClick={() => handlePageChange(currentPage + 1)}
                            ...
                            className="border rounded px-3 py-1 mx-1"
                        >
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 md:w-6 md:h-6 rotate-180"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.3723 4.64576C14.5671 4.45141 14.883 4.45141 15.0778 4.64576L15.8539 5.41993C16.0487 5.61427 16.0487 5.92937 15.8539 6.12372L9.96317 12L15.8539 17.8763C16.0487 18.0706 16.0487 18.3857 15.8539 18.5801L15.0778 19.3542C14.883 19.5486 14.5671 19.5486 14.3723 19.3542L7 12L14.3723 4.64576Z" fill="currentColor"></path></svg>
                        </button>
                    </div>
                </div>
            </main>
