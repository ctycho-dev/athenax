                            ...
                            <td className="px-4 py-4 w-max">
                                <div className="flex gap-10 items-center w-max">
                                    {![ReportState.COMPLETED, ReportState.REJECTED].includes(item.state) &&
                                        <Link to={`/${item.type}-form/${item.id}?step=1`} className="text-light-blue-3 hover:text-light-1 hover:cursor-pointer"><span className="font-medium text-sm">Edit Info</span></Link>
                                    }
