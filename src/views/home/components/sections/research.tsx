            ...
            <div className="grid md:grid-cols-2 gap-6">
                <Card className="p-6 md:p-10 flex flex-col justify-between">
                    <div className="flex justify-center -mr-6 md:-mr-10">
                        <picture>
                            <source srcSet="https://link.storjshare.io/raw/ju2w2pwwq3t7q4qtotibpugp4oxq/athenax/research/fees.webp" type="image/webp" />
                            <source srcSet="https://link.storjshare.io/raw/jw4tpfuylnazzkngfpvffpsny3eq/athenax/research/fees.png" type="image/png" />
                            <img src="https://link.storjshare.io/raw/jw4tpfuylnazzkngfpvffpsny3eq/athenax/research/fees.png" srcSet="https://link.storjshare.io/raw/jw4tpfuylnazzkngfpvffpsny3eq/athenax/research/fees.png" alt="News" />
                        </picture>
                    </div>
                    <div className="pt-6">
                ...
                <Card className="p-6 md:p-10 flex flex-col justify-between">
                    <div className="flex justify-center  -mr-6 md:-mr-10">
                        <picture>
                            <source srcSet="https://link.storjshare.io/raw/juvjf2t434ghmlga7oo7qskdlcxq/athenax/research/token.webp" type="image/webp" />
                            <source srcSet="https://link.storjshare.io/raw/jwt72edk7q4igwwh46qds6ldydsq/athenax/research/token.png" type="image/png" />
                            <img src="https://link.storjshare.io/raw/jwt72edk7q4igwwh46qds6ldydsq/athenax/research/token.png" srcSet="https://link.storjshare.io/raw/jwt72edk7q4igwwh46qds6ldydsq/athenax/research/token.png" alt="News" />
                        </picture>
                    </div>
                    <div className="pt-6">
