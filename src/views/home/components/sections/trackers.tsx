        ...
        <CustomSection>
            ...
            <div className="grid grid-cols-12 gap-6">
                <Card className="relative col-span-12 pl-6 md:pl-10 py-6 md:py-10 flex flex-col-reverse md:flex-row justify-between md:items-end">
                    ...
                    <picture>
                        <source 
                            srcSet={`${s3('home/trackers/watchlist-2x.webp')} 2x, ${s3('home/trackers/watchlist-3x.webp')} 3x`} 
                            type="image/webp" 
                        />
                        <source 
                            srcSet={`${s3('home/trackers/watchlist-2x.png')} 2x, ${s3('home/trackers/watchlist-3x.png')} 3x`} 
                            type="image/png" 
                        />
                        <img 
                            src={s3('home/trackers/watchlist-3x.png')} 
                            srcSet={`${s3('home/trackers/watchlist-2x.png')} 2x, ${s3('home/trackers/watchlist-3x.png')} 3x`} 
                            alt="Watchlist" 
                        />
                    </picture>
                ...
                <Card className="col-span-12 md:col-span-6 p-6 md:p-10">
                    <div className="flex justify-center">
                        <picture>
                            <source srcSet={s3('home/trackers/notification.webp')} type="image/webp" />
                            <source srcSet={s3('home/trackers/notification.png')} type="image/png" />
                            <img
                                src={s3('home/trackers/notification.png')}
                                srcSet={s3('home/trackers/notification.png')}
                                alt="Notification"
                            />
                        </picture>
                    </div>
                ...
                <Card className="card-bg relative col-span-12 md:col-span-6 pl-6 md:pl-10 py-6 md:py-10 -z-10 flex flex-col justify-between">
                    <picture>
                        <source srcSet={s3('home/trackers/trends.webp')} type="image/webp" />
                        <source srcSet={s3('home/trackers/trends.png')} type="image/png" />
                        <img
                            src={s3('home/trackers/trends.png')}
                            srcSet={s3('home/trackers/trends.png')}
                            alt="Trends"
                        />
                    </picture>
                    <div className="pt-6">
